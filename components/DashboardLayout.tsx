...
export default function DashboardLayout() {
  ...
  return (
    <div className="flex w-full min-h-[100dvh] overflow-x-hidden bg-neutral-background dark:bg-slate-900 transition-colors duration-500">
      <Sidebar
        departments={departments}
        selectedDepartment={selectedDepartment}
        onSelectDepartment={setSelectedDepartment}
      />
      <main className="flex-1 w-full min-w-0 overflow-y-auto overflow-x-hidden relative pt-16 md:pt-0">
