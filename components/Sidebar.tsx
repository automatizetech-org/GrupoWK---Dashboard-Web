    ...
    <>
      ...
      <div
        className={`fixed inset-0 z-40 md:hidden transition-opacity duration-300 ${
          isOpen ? 'opacity-100 bg-black/50 pointer-events-auto' : 'opacity-0 bg-black/50 pointer-events-none'
        }`}
      ...
      {/* Drawer (mobile) — com animação (não empurra o layout) */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-gradient-to-b from-neutral-surface via-neutral-surface to-neutral-background dark:from-slate-800 dark:via-slate-800 dark:to-slate-900 border-r border-neutral-border dark:border-slate-700 flex flex-col shadow-3d overflow-hidden md:hidden transform-gpu transition-transform duration-300 ease-out ${
